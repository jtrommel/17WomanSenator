...
Same calculation but with the latest forecasts by 538.
...
<<label=Sim2,fig=TRUE,include=FALSE, echo=FALSE>>=
grid.arrange(p1, p2, nrow=1)
@
...
Average of independent and dependent model:
...
\begin{tabular}{ l r }
  19 or fewer & 0 \\
  20 & 0 \\
  21 & \Sexpr{result.avg$perc.round[2]} \\
  22 & \Sexpr{result.avg$perc.round[3]} \\
  23 & \Sexpr{result.avg$perc.round[4]} \\
  24 & \Sexpr{result.avg$perc.round[5]} \\
  25 or more & \Sexpr{result.avg$perc.round[6] + result.avg$perc.round[7]} \\
\end{tabular}
